        ...
        <Card>
          ...
          <CardContent className="grid gap-2">
            <Button variant="outline" className="justify-start gap-2" asChild>
              <Link href="/doctors"><Stethoscope className="h-4 w-4" />Find a Doctor</Link>
            </Button>
            <Button variant="outline" className="justify-start gap-2" asChild>
              <Link href="/diagnostics"><FlaskConical className="h-4 w-4" />Book a Test</Link>
            </Button>
            <Button variant="outline" className="justify-start gap-2" asChild>
              <Link href="/hospitals"><Hospital className="h-4 w-4" />Search Hospitals</Link>
            </Button>
            <Button variant="outline" className="justify-start gap-2" asChild>
              <Link href="/records"><FileText className="h-4 w-4" />View My Records</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
